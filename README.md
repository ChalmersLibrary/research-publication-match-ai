...
* A decent PC (Windows, Mac, Linux) with at least 8 GB RAM (16 GB preferred) and quadcore CPU (primarily for generating the vector store). Mac or Linux is preferred due to better GPU handling.               
